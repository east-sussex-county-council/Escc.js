if (typeof (jQuery) != 'undefined')
{
    ...
    // jQuery(function () { Escc.Statistics.TrackWithGoogleAnalytics({ domains: ['eastsussex.gov.uk', 'eastsussexcc.gov.uk'] }); });
    var Escc = { Statistics: {
        TrackWithGoogleAnalytics: function (options)
        {
            ...
            .click(function ()
            {
                ...
                if (typeof (ga) !== 'undefined') ga('send', 'pageview', jQuery(this).attr("href").toLowerCase());
            });
            ...
            .click(function ()
            {
                ...
                if (typeof (ga) !== 'undefined') ga('send', 'event', 'external links', document.URL, jQuery(this).attr("href"), 0);
            });
