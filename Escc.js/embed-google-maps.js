if (typeof jQuery !== 'undefined' && typeof esccGoogleMaps !== 'undefined') {
    $(function () {
        var apiKey = $("[data-google-maps-api-key]").data("google-maps-api-key");
        if (apiKey) {
            esccGoogleMaps.loadGoogleMapsApi({ apiKey: apiKey, callback: "esccEmbedLinkedGoogleMap" });
        }
    });
}

function esccEmbedLinkedGoogleMap() {
    $("a.embed, span.embed a")
