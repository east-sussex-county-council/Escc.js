...
if (typeof (jQuery) !== 'undefined') {
    ...
    $(function () {
        ...
        $("span.embed > a, a.embed").filter(function (index) {
            ...
            if (!embedElement.hasClass("embed")) embedElement = embedElement.parent();
            $(embedElement).replaceWith('<iframe width="' + youTubeWidth + '" height="' + youTubeHeight + '" src="https://www.youtube-nocookie.com/embed/' + match[2] + '" frameborder="0" allowfullscreen="allowfullscreen" class="video"></iframe>');
        });
