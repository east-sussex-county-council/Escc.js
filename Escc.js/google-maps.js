if (typeof jQuery !== 'undefined') {
    var esccGoogleMaps = (function () {
        ...
        this.loadGoogleMapsApi = function (options) {
            ...
            var defaultOptions = { libraries: '', callback: '', apiKey: '' };
            if (options) $.extend(defaultOptions, options);

            var script = document.createElement("script");
            script.src = "https://maps.googleapis.com/maps/api/js?libraries=" + defaultOptions.libraries + "&key=" + defaultOptions.apiKey + "&callback=" + defaultOptions.callback;
